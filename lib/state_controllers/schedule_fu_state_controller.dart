...
class ScheduleFormUpdateStateController extends RegularStateController {
  late ScheduleFormUpdateFormSource formSource;
  ScheduleFormUpdateDataSource dataSource = ScheduleFormUpdateDataSource();
  late ScheduleFormUpdateListener listener;
  ...
  void onInit() async {
    super.onInit();
    listener = ScheduleFormUpdateListener(this);
    formSource = ScheduleFormUpdateFormSource(listener);
