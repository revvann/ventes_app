...
import 'package:ventes/state_sources/data_sources/schedule_fu_data_source.dart';
import 'package:ventes/state_sources/form_sources/schedule_fc_form_source.dart';
import 'package:ventes/state_sources/form_validators/schedule_fu_validator.dart';
import 'package:ventes/state_sources/state_listeners/schedule_fu_listener.dart';

class ScheduleFormUpdateFormSource {
  ScheduleFormUpdateFormSource(this.listener);
  ScheduleFormUpdateListener listener;

  int readOnlyId = 14;
  int addMemberId = 15;
  int shareLinkId = 16;

  late ScheduleFormUpdateDataSource dataSource;
